...
(* CHANGE: Add a case for Shift expressions *)
      | Shift (dx,dy,sub) => shift (dx, dy, eval_prog(sub, env))

(* CHANGE: Add function preprocess_prog of type geom_exp -> geom_exp *)
fun preprocess_prog (e) =
    case e of
	LineSegment (a1, b1, a2, b2) => (if real_close_point (a1,b1) (a2,b2) then Point(a1, b1) 
					else if real_close (a1,a2) andalso b1 > b2 then LineSegment (a2,b2,a1,b1)
					else if real_close (a1,a2) andalso b1 < b2 then e
					else if a1 > a2 then LineSegment (a2,b2,a1,b1)
					else e )								 
      | Intersect (e1, e2) => Intersect (preprocess_prog(e1), preprocess_prog(e2))
      | Shift (dx, dy, sub) => Shift (dx, dy, preprocess_prog(sub))
