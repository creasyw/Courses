...
% MISO
% channel g11,g21,g31,g41 fast fading, Nt=4 (number of receiver antenna)
...
h2=g21./sqrt(Aver2); % channel normalization
h3=g31./sqrt(Aver3); % channel normalization
h4=g41./sqrt(Aver4); % channel normalization
SNR_dB=[-20:2:20];
SNR=10.^(SNR_dB/10);
M=length(SNR_dB);
C=zeros(1,M);
...
title('channel capacity of IS-95 with channel converstion (4X1)');