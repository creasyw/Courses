...
def test_remove_duplicates():
    ...
    suite.run_test(
        mycode.remove_duplicates([1, 1, 1, 1, 2, 3]), [1, 2, 3], "Test 2")
    suite.run_test(
        mycode.remove_duplicates([1, 2, 2, 2, 2, 3, 3]), [1, 2, 3], "Test 3")
...
def test_intersect():
    ...
    suite.run_test(
        mycode.intersect([1, 1, 2, 2, 4], [1, 2, 3]), [1, 2], "Test 5")
    suite.run_test(
        mycode.intersect([1, 1, 1, 1, 1], [1, 1, 2, 3]), [1, 1], "Test 6")
    suite.report_results()
...
def test_merge():
    ...
    suite.run_test(
        mycode.merge([1, 2, 3], [1, 2, 3]), [1, 1, 2, 2, 3, 3], "Test 3")
    suite.run_test(
        mycode.merge([1, 2, 3], [0, 4, 5]), [0, 1, 2, 3, 4, 5], "Test 4")
    suite.report_results()
...
def test_merge_sort():
    ...
    suite.run_test(
        mycode.merge_sort([38, 27, 43, 3, 9, 82, 10]), [3, 9, 10, 27, 38, 43,
                                                        82], "Test 4")
    suite.report_results()
...
def test_gen_all_strings():
    ...
    suite.run_test(
        ...
        set(["", "b", "a", "ab", "ba", "a", "ab", "ba", "aa", "aa", "aab",
             "aab", "aba", "aba", "baa", "baa"]), "Test")
    suite.report_results()
