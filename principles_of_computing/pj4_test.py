...
def test_strategy():
    ...
    hand = (1, 3, 5, 3, 3)
    suite.run_test(
        strategy(hand, num_die_sides), (10.24, (3, 3, 3)), "Test #1:")

    num_die_sides = 4
    hand = (3, 3, 3, 3)
    suite.run_test(
        strategy(hand, num_die_sides), (12.0, (3, 3, 3, 3)), "Test #2:")

    num_die_sides = 4
    hand = (3, 1, 4, 4, 4)
    suite.run_test(
        strategy(hand, num_die_sides), (14.0, (4, 4, 4)), "Test #3:")
    ...
    hand = (3, 1, 1, 3, 2)
    suite.run_test(
        strategy(hand, num_die_sides), (8.53125, (3, 3)), "Test #5:")
