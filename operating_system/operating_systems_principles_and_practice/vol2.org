...
There are various kinds of scheduling policies and goals (e.g. maximizing throughput, minimizing wait time, or fairness). All of them are /to decide which job should be take off from the ready queue.
